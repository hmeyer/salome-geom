...
GEOMImpl_Gen::GEOMImpl_Gen()
{
   ...
   TFunction_DriverTable::Get()->AddDriver(GEOMImpl_CurveDriver::GetID(), new GEOMImpl_CurveDriver());
   ...
   TFunction_DriverTable::Get()->AddDriver(GEOMImpl_PlateDriver::GetID(), new GEOMImpl_PlateDriver());
   ...
   TFunction_DriverTable::Get()->AddDriver(GEOMImpl_DraftDriver::GetID(), new GEOMImpl_DraftDriver());
